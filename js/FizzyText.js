function generateRandomColors(){
	return ["#00aeff", "#0fa954", "#54396e", "#e61d5f"];
}
...
function FizzyText(message) {
  ...
  this.maxSize = 1.365;          // how big can they get?
  this.noiseStrength = 25;      // how turbulent is the flow?
  this.speed = 0.35;             // how fast do particles move?
